class PagesController < ApplicationController
    ...
    def disable_branch
        @branch = Branch.find(params[:id])
        @branch.active == true ? @branch.active = false : @branch.active = true
        @branch.save
        redirect_to pages_branches_path
    end
    ...
    def reports
        ...
        prom_loc_entrance = prom_loc_entrance/cont
        prom_loc_out = prom_loc_out/cont
